...
const leetcodeNoteDefinitions = [
  ...
  createTutorialDefinition(
    'Core Skills 8 · Sorting Algorithms',
    'CoreSkills08 Insertion Sort.md',
    'CoreSkills08 Insertion Sort.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 8 · Sorting Algorithms', category: 'Sorting', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 9 · Dynamic Programming',
    'CoreSkills09 Decode Ways Dynamic Programming.md',
    'CoreSkills09 Decode Ways Dynamic Programming.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 9 · Dynamic Programming', category: 'Dynamic Programming', difficulty: 'Hard' },
  ),
  createTutorialDefinition(
    'Core Skills 10 · Greedy Algorithms',
    'CoreSkills10 Greedy Algorithms.md',
    'CoreSkills10 Greedy Algorithms.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 10 · Greedy Algorithms', category: 'Greedy', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 11 · Interval Problems',
    'CoreSkills11 Interval Problems.md',
    'CoreSkills11 Interval Problems.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 11 · Interval Problems', category: 'Intervals', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 12 · Math: Fast Power & Sampling',
    'CoreSkills12 Math and Sampling.md',
    'CoreSkills12 Math and Sampling.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 12 · Math: Fast Power & Sampling', category: 'Math', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 13 · Bit Manipulation: XOR',
    'CoreSkills13 Bit Manipulation XOR.md',
    'CoreSkills13 Bit Manipulation XOR.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 13 · Bit Manipulation: XOR', category: 'Math', difficulty: 'Easy' },
  ),
  createTutorialDefinition(
    'Core Skills 14 · String Basics',
    'CoreSkills14 String Basics Encode Decode.md',
    'CoreSkills14 String Basics Encode Decode.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 14 · String Basics', category: 'Strings', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 15 · Two Pointers',
    'CoreSkills15 Two Pointers.md',
    'CoreSkills15 Two Pointers.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 15 · Two Pointers', category: 'Two Pointers', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 16 · Sliding Window',
    'CoreSkills16 Sliding Window.md',
    'CoreSkills16 Sliding Window.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 16 · Sliding Window', category: 'Sliding Window', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 17 · Stack & Monotonic Stack',
    'CoreSkills17 Stack MinStack Monotonic Stack.md',
    'CoreSkills17 Stack MinStack Monotonic Stack.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 17 · Stack & Monotonic Stack', category: 'Stacks', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 18 · Binary Search',
    'CoreSkills18 Binary Search.md',
    'CoreSkills18 Binary Search.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 18 · Binary Search', category: 'Binary Search', difficulty: 'Medium' },
  ),
  createTutorialDefinition(
    'Core Skills 19 · Tries',
    'CoreSkills19 Design Trie.md',
    'CoreSkills19 Design Trie.en.md',
    { directory: 'Leetcode', titleEn: 'Core Skills 19 · Tries', category: 'Tries', difficulty: 'Hard' },
  ),
  createTutorialDefinition(
    'Core Skills 20 · Backtracking',
    'CoreSkills20 Backtracking.md',
...
const legacyRoutes = {
  ...
  'CoreSkills10 Insertion Sort.md': 'CoreSkills08 Insertion Sort.md',
  'CoreSkills10 Decode Ways Dynamic Programming.md': 'CoreSkills09 Decode Ways Dynamic Programming.md',
  'CoreSkills21 Decode Ways Dynamic Programming.md': 'CoreSkills09 Decode Ways Dynamic Programming.md',
  'CoreSkills23 Dynamic Programming Patterns.md': 'CoreSkills09 Decode Ways Dynamic Programming.md',
  'CoreSkills11 Rejection Sampling Rand10.md': 'CoreSkills12 Math and Sampling.md',
  'CoreSkills22 Rejection Sampling Rand10.md': 'CoreSkills12 Math and Sampling.md',
  'CoreSkills12 Greedy Algorithms.md': 'CoreSkills10 Greedy Algorithms.md',
  'CoreSkills23 Greedy Algorithms.md': 'CoreSkills10 Greedy Algorithms.md',
  'CoreSkills13 Interval Problems.md': 'CoreSkills11 Interval Problems.md',
  'CoreSkills24 Interval Problems.md': 'CoreSkills11 Interval Problems.md',
  'CoreSkills14 Math Binary Exponentiation.md': 'CoreSkills12 Math and Sampling.md',
  'CoreSkills25 Math Binary Exponentiation.md': 'CoreSkills12 Math and Sampling.md',
  'CoreSkills15 Bit Manipulation XOR.md': 'CoreSkills13 Bit Manipulation XOR.md',
  'CoreSkills26 Bit Manipulation XOR.md': 'CoreSkills13 Bit Manipulation XOR.md',
  'CoreSkills16 String Basics Encode Decode.md': 'CoreSkills14 String Basics Encode Decode.md',
  'CoreSkills27 String Basics Encode Decode.md': 'CoreSkills14 String Basics Encode Decode.md',
  'CoreSkills17 Two Pointers.md': 'CoreSkills15 Two Pointers.md',
  'CoreSkills28 Two Pointers.md': 'CoreSkills15 Two Pointers.md',
  'CoreSkills18 Sliding Window.md': 'CoreSkills16 Sliding Window.md',
  'CoreSkills29 Sliding Window.md': 'CoreSkills16 Sliding Window.md',
  'CoreSkills19 Stack MinStack Monotonic Stack.md': 'CoreSkills17 Stack MinStack Monotonic Stack.md',
  'CoreSkills30 Stack MinStack Monotonic Stack.md': 'CoreSkills17 Stack MinStack Monotonic Stack.md',
  'CoreSkills20 Binary Search.md': 'CoreSkills18 Binary Search.md',
  'CoreSkills31 Binary Search.md': 'CoreSkills18 Binary Search.md',
  'CoreSkills21 Design Trie.md': 'CoreSkills19 Design Trie.md',
    ...
    <div className={`site-shell ${currentView === 'home' ? 'home-view' : 'reader-view'}`}>
      <header className="top-nav">
        <button className="brand-lockup" type="button" onClick={navigateHome}>
          ...
          <span>
            <strong>
              MLPHDINTERVIEW <span className="brand-url">(https://currytang.github.io/mlphdinterview)</span>
            </strong>
