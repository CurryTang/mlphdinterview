...
**Fatal Error**: Multiplying marginal expectations directly yields $\left( \frac{5}{3} \r\right)^6 \approx 21.43$. This is **completely incorrect**.
...
$$
\mathbb{E}[N_1^2 N_2 \dots N_6] = \mathbb{E}[(N_1)_2 N_2 \dots N_6] + \mathbb{E}[(N_1)_1 N_2 \dots N_6] = (10)_7 \left( \frac16 \r\right)^7 + (10)_6 \left( \frac16 \r\right)^6
$$
...
$$
\operatorname{Var}(K_n) = \sum_{i=1}^n \operatorname{Var}(I_i) = \sum_{i=1}^n \frac{1}{i}\left( 1 - \frac{1}{i} \r\right) = \sum_{i=1}^n \frac{1}{i} - \sum_{i=1}^n \frac{1}{i^2}
$$
