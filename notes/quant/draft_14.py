...
- **Beta ($\beta$)**: The asset's systematic risk exposure relative to broad market fluctuations.

- **Alpha ($\alpha$)**: The specific, idiosyncratic excess return generated by the asset itself, independent of systematic risk. Stripping away Beta to capture pure, robust Alpha is the core objective of quantitative strategies.
