...
> - **RL 1（偏好对齐）**：[[MLCoding06B RLHF Preference Alignment PPO DPO.md|ML Coding 06B · RLHF 与偏好对齐全景：从 Reward Model、PPO 4 模型架构到 DPO/IPO/KTO/SimPO 与对齐税]]
> - **RL 2（推理与智能体）**：[[MLCoding06C RLVR Reasoning GRPO Agentic RL.md|ML Coding 06C · RLVR、推理大模型与 Agentic RL：DeepSeek-R1 演进路径、GRPO 算法推导、规则验证器与 Agent 强化学习]]
