...
> - **RL 1（偏好对齐）**：[[MLCoding06B RLHF Preference Alignment PPO DPO.md|06B · RLHF 与偏好对齐全景]]
> - **RL 2（推理与智能体）**：[[MLCoding06C RLVR Reasoning GRPO Agentic RL.md|06C · RLVR、推理模型与 Agentic RL]]
> - **RL 3（系统架构与 Infra 实战）**：**本篇（自测 35 问）**——直击高并发 Rollout 调度、vLLM/SGLang 引擎解耦、异步通信拓扑与显存优化 35 核心问答。
