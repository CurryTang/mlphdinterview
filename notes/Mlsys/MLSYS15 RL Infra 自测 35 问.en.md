...
$$
\mathcal{L}_{\text{clip}} = \mathbb{E}_t\left[ \min\left(\underbrace{r_t \hat{A}_t}_{\text{original objective}},\ \underbrace{\text{clip}(r_t, 1-\epsilon, 1+\epsilon)\hat{A}_t}_{\text{clipped version}} \r\right) \r\right]
$$
